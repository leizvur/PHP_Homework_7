...
//Текст сертификата
$cert_text="Поздравляем! Ты успешно прошел тест! Этот сертификат подтверждает, что ты на 33% рожденный в СССР!";
session_start();
...
imagettftext($image, 40, 0, 200, 100, $text_color, $font_ttf, $cert_text);
